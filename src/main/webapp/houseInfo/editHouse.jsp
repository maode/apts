		...
		<div class="main-content">
			<div class="page-content">
				<div class="page-header">
					<h1>
						控制台 <small> <i class="icon-double-angle-right"></i> 修改房源
						</small>
					</h1>
				</div>
				<div class="page-body" >
					<form class="form-horizontal" method="post"
						action="editHouseDo.action" id="webform"
						...
						<div class="form-group">
							...
							<div class="col-md-10" style="display: none;" id="picUpDiv">
								<s:file name="files" />
								<s:file name="files" />
								<s:file name="files" />
								<s:file name="files" />
							...
							<div class="col-md-10" id="picDisDiv">
								<s:iterator value="pics">
									<img src="downloadHousePic/?picture.id=<s:property  value="id"/>">
								</s:iterator>
								<button onclick="reUpPic();">重新上传</button>
							</div>
						</div>
