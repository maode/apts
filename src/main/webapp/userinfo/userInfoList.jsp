			...
			<div class="main-content">
				<div class="page-content">
					<div class="page-header">
						<h1>
							控制台 <small> <i class="icon-double-angle-right"></i> 用户管理列表
							</small>
						</h1>
					</div>
					<div class="row">
									...
									<img style="height: 100px;width: 150px;" alt="" src="<%=request.getContextPath() %>/getpic.action?params=${idcardPath}">
										...
										<div  style="width: 100%;height: 40px;"></div>
											<div
												...
												<button class="btn btn-xs btn-info"  onclick="resetpass(${id})">
													<i class="icon-edit bigger-120"></i>重设密码
												</button>
											...
											<div class="visible-xs visible-sm hidden-md hidden-lg">
												<div class="inline position-relative">
													...
													<ul
														...
														<li><a href="#" class="tooltip-success"  onclick="resetpass(${id})"
